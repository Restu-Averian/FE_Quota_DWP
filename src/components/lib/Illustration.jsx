...
const Login = () => {
  return (
    ...
    >
      <path
        id="uuid-fb20b2b5-bc5b-4117-a1ee-c5d1a8aa62bd-112"
      ...
      />
      <path
        id="uuid-e639489a-d12b-4c23-97cb-2af79ea40b7d-113"
      ...
      />
      <path
        id="uuid-56df27a3-bbb6-4bd2-b7f5-888148e3fe66-114"
      ...
      />
      <path
        id="uuid-e3777ca2-fb97-40f5-b301-a7df89d05aed-115"
 ...
 *
 * @param {object} props
 * @param {keyof illustrasi} props.name
 * @returns
 */
const Illustration = ({ name }) => {
  if (!illustrasi[name] && !name) return <Fragment />;
  return illustrasi[name];
};
